...
public class MbtiAlignmentJudge {
    ...
    static final List<MbtiQuestion> QUESTIONNAIRE = List.of(
            ...
            new MbtiQuestion(4, "SN", "N", "Does this agent focus on concrete, established methods and facts (A) or explore abstract patterns and novel possibilities (B)?"),
            ...
            new MbtiQuestion(6, "SN", "N", "Does this agent prefer proven approaches with track records (A) or innovative solutions that challenge conventions (B)?"),
