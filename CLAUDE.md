...
│       ├── yaml/                        — EidosDescriptorModule (Jackson Module, registers custom deserializers), AgentDescriptorDeserializer (YAML→AgentDescriptor via builder), DispositionDeserializer (String axis→DispositionValue, mbtiType/enneagramType convenience via VocabularyRegistry)
