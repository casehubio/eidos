...
│       ├── AgentConstraint.java         — behavioral guardrail record: name, description, Visibility (PUBLIC/PRIVATE); validated in compact constructor
